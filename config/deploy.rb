...
set :application, "websocket-game"
...
role :web, "websocket-game.com"                          # Your HTTP server, Apache/etc
role :app, "websocket-game.com"                         # This may be the same as your `Web` server
role :db,  "websocket-game.com"   , :primary => true # This is where Rails migrations will run
